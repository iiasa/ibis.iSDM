...
#' where eqn{u} and eqn{l} are the upper and lower asymptotes of the logistic curve,
#' eqn{r} is a rate that gives flexibility to the curve from a sharpe step to a
#' flat surface and eqn{s} is a measure of skewness that adjust the symmetry of
#' the decay on the edge of the expert map. As for eqn{k}, it shifts the curve
#' inside or outside the expert map. Finally, eqn{x} is the provided vector.
