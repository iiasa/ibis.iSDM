...
object. In order to remove a set prior, the name of the prior has to be
specified.
...
- names:
  ...
  A [`vector`](https://rdrr.io/r/base/vector.html) or
  [`character`](https://rdrr.io/r/base/character.html) object for priors
  to be removed.
