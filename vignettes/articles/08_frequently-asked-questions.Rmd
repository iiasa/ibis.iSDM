...
<details>
<summary><b>I am predicting over a large area, is there a way to parallize the computation?</b>
</summary>
...
If you aim to parallelize over a range of species instead, it might be more worthhile
to rather parallize the iteration and not the prediction.
