...
-   [hSDM](https://github.com/ghislainv/hSDM) -&gt; Bayesian framework for hierarchical and mixed models. Fast, but little flexibility with regards to weights, offsets and different datatypes.
