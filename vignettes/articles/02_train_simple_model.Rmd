...
article_packages <- c("INLA", "inlabru", "xgboost", "terra", "sf", "uuid", "assertthat")
run_examples <- !is_check && all(vapply(article_packages, requireNamespace, logical(1), quietly = TRUE))
knitr::opts_chunk$set(fig.align = "center", eval = run_examples)
```
