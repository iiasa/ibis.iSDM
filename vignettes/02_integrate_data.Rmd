...
* Monotonic constraints on the direction of a coefficient and predictor in the model, such that is $f(x_1) >= f(x_2)$ or  $f(x_1) <= f(x_2)$. Useful to incorporate for instance prior ecological knowledge on that a certain response function has to be positive.
