...
By default, presence only biodiversity data is modelled as point-process model (PPM, see [Renner e tal. 2015](http://doi.wiley.com/10.1111/2041-210X.12352)). Similar as Maximum Entropy models these models can be quite sensitive to biased input, which is common for most non-structured biodiversity observations where presence points tend to be clustered in urban or easily accessible areas. To avoid predictions being biased towards those covariates, there are a number of things that can potentially be done here.

* Modify the targeted background sampling for better control of background points. More options to modify this will be made available.
* Make use of spatial thinning approaches. See for instance [Aiello-Lammers et al. 2015](https://onlinelibrary.wiley.com/doi/full/10.1111/ecog.01132) and [Steen et al. 2021](https://besjournals.onlinelibrary.wiley.com/doi/abs/10.1111/2041-210X.13525).
