...
Also see the `add_pseudoabsence()` and `pseudoabs_settings()` help pages for more settings and also the first article on this website.

**By default all engines in ibis.iSDM fit models according to the input data. When presence-only data is supplied, then usually a Poisson-Process Model is estimated. **
</details>
