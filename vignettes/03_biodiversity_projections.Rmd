...
x <- distribution(background) %>%
  ...
  engine_glmnet(alpha = 0) # Slightly increase the learning rate

# Train the model
modf <- train(x, runname = 'Simple PPM', only_linear = FALSE, verbose = FALSE)
...
plot(totchange_gain_km2~band, data = o, type = 'n',
     main = "Habitat gain and loss", ylim = c(-1e4, 1e4),
     ylab = "Amount of area (km2)", xlab = "Time")
