...
namespace model_lm_stan_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_lm_stan");
    reader.add_event(32, 30, "end", "model_lm_stan");
    return reader;
}
#include <stan_meta_header.hpp>
class model_lm_stan
  : public stan::model::model_base_crtp<model_lm_stan> {
private:
        int N;
        vector_d x;
        vector_d y;
public:
    model_lm_stan(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_lm_stan_namespace::model_lm_stan";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_lm_stan_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_lm_stan_namespace::model_lm_stan stan_model;
#ifndef USING_R
