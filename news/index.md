...
- Preparing for CRAN release, including documentation and minor code
  fixes [\#154](https://github.com/iiasa/ibis.iSDM/issues/154)
...
- Extended
  ...
  masking during scenario projections.
- Replacement of the `st_kde` function with an internal implementation
  of kernel density estimation in c++ for speed.
