...
x <- distribution(background) %>%
  ...
  add_predictors(predictors,transform = 'scale',derivates = 'quadratic') %>% 
...
mod <- train(x %>% set_priors(priors = INLAPrior('bio01_mean_50km','normal',c(2,100))), runname = 'INLA test run')
