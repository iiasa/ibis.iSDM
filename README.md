...
[![R-CMD-check](https://github.com/iiasa/ibis.iSDM/actions/workflows/R-CMD-check_linux.yaml/badge.svg)](https://github.com/iiasa/ibis.iSDM/actions/workflows/R-CMD-check-linux.yaml)
[![License: CC BY
